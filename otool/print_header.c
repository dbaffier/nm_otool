...
/*   Updated: 2019/12/12 18:50:43 by dbaffier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		print_mach_header(struct mach_header *mh)
{
	...
	ft_printf("      magic cputype cpusubtype  caps    filetype ncmds "
	       "sizeofcmds      flags\n");
	//ft_printf(" 0x%08x %7d %10d %10lu %5lu %10lu 0x%08x\n",
	...
	ft_printf(" 0x%08x %7d %10d  0x%02x  %10u %5u %10u 0x%08x\n",
		   (unsigned int)mh->magic, mh->cputype, mh->cpusubtype & ~CPU_SUBTYPE_MASK,
...
void		print_mach_header_64(struct mach_header_64 *mh64)
{
	...
	ft_printf(" 0x%08x %7d %10d  0x%02x  %10u %5u %10u 0x%08x\n",
		   (unsigned int)mh64->magic, mh64->cputype, mh64->cpusubtype & ~CPU_SUBTYPE_MASK,
